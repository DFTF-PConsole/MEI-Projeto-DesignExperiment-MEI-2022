---
title: "Hyp 2: Two-Way ANOVA Repeated Measures"
...
setwd("/home/jekyll/MEI/2_Ano/MEI/Pratica/MEI-Trabalhos-2022/Trabalho/hyp_2/two_way_anova_rm")

# Read data
df <- read.csv("new_results_paired.csv")

# Data Pre-processing
data <- df[df$vertices>=300&df$probability==0.1, ]
